...
namespace BizPRO.CRM.V2.Dominio.Entidades
{
    public class EmailAnexo
    {
        ...
        public bool ImagemCorpo { get; private set; }
        ...
        public EmailAnexo(string extensao, string nome, string path, long tamanho, bool imagemCorpo, string contentId,
            string identificadorAnexoItem)
        {
            ValidationResult = new ValidationResult();
            Ativo = true;
            Extensao = extensao;
            Path = path;
            Tamanho = tamanho;
            ImagemCorpo = imagemCorpo;
            ContentId = string.IsNullOrEmpty(contentId) ? null : contentId.Replace("<", "").Replace(">", "");
            Nome = nome;
            CriadoEm = DateTime.Now;
            IdProvisorio = Guid.NewGuid().ToString();
        ...
        public void SetarEmailId(long id)
        {
            EmailId = id;
        }
        ...
        public string ContentType()
        {
            ...
            switch (Extensao)
            {
                ...
                case "aca":
                    ...
                    break;
                case "accda":
                    contentType = "application/msaccess.addin";
                    break;
                case "accdb":
                    contentType = "application/msaccess";
                    break;
                case "accdc":
                    contentType = "application/msaccess.cab";
                    break;
                case "accde":
                    contentType = "application/msaccess";
                    break;
                case "accdr":
                    contentType = "application/msaccess.runtime";
                    break;
                case "accdt":
                    contentType = "application/msaccess";
                    break;
                case "accdw":
                    contentType = "application/msaccess.webapplication";
                    break;
                case "accft":
                    contentType = "application/msaccess.ftemplate";
                    break;
                case "acx":
                ...
                case "caf":
                    ...
                    break;
                case "calx":
                    contentType = "application/vnd.ms-office.calx";
                    break;
                case "cat":
                ...
                case "hdml":
                    ...
                    break;
                case "hhc":
                    contentType = "application/x-oleobject";
                    break;
                case "hhk":
                    contentType = "application/octet-stream";
                    break;
                ...
                case "ipa":
                    ...
                    break;
                case "ipg":
                    contentType = "application/x-itunes-ipg";
                    break;
                case "ipproj":
                    contentType = "text/plain";
                    break;
                case "ipsw":
                    contentType = "application/x-itunes-ipsw";
                    break;
                case "iqy":
                ...
                case "isp":
                    ...
                    break;
                case "ite":
                    contentType = "application/x-itunes-ite";
                    break;
                case "itlp":
                    contentType = "application/x-itunes-itlp";
                    break;
                case "itms":
                    contentType = "application/x-itunes-itms";
                    break;
                case "itpc":
                    contentType = "application/x-itunes-itpc";
                    break;
                case "IVF":
                ...
                case "java":
                    ...
                    break;
                case "jck":
                    contentType = "application/liquidmotion";
                    break;
                case "jcz":
                    contentType = "application/liquidmotion";
                    break;
                ...
                case "mvb":
                    ...
                    break;
                case "mvc":
                    contentType = "application/x-miva-compiled";
                    break;
                case "mxp":
                ...
                case "pbm":
                    ...
                    break;
                case "pcast":
                    contentType = "application/x-podcast";
                    break;
                case "pct":
                ...
                case "s":
                    ...
                    break;
                case "safariextz":
                    contentType = "application/x-safari-safariextz";
                    break;
                case "scd":
                ...
                case "settings":
                    ...
                    break;
                case "sgimb":
                    contentType = "application/x-sgimb";
                    break;
                case "sgml":
                ...
                case "wdp":
                    ...
                    break;
                case "webarchive":
                    contentType = "application/x-safari-webarchive";
                    break;
                case "webtest":
                    contentType = "application/xml";
                    break;
                ...
                case "WLMP":
                    ...
                    break;
                case "wlpginstall":
                    contentType = "application/x-wlpg-detect";
                    break;
                case "wlpginstall3":
                    contentType = "application/x-wlpg3-detect";
                    break;
                case "wm":
                ...
                case "wvx":
                    ...
                    break;
                case "x":
                    contentType = "application/directx";
                    break;
                case "xaf":
                    contentType = "x-world/x-vrml";
                    break;
